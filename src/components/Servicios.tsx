    ...
    <section id="servicios" className="py-28 bg-gradient-to-b from-black to-[rgba(17,24,39,0.35)]">
      <div className="w-full max-w-[1160px] mx-auto px-6">
        <FadeInUp className="text-center mb-14">
          ...
          <h2 className="font-['Neue_Haas_Grotesk_Display'] text-[clamp(1.9rem,4vw,3rem)] font-bold text-white mb-5 leading-[1.1]">
        ...
        >
          {services.map((s) => (
            ...
            >
              ...
              <div>
                <h3 className="font-['Neue_Haas_Grotesk_Display'] text-[0.95rem] font-bold text-white mb-[0.35rem]">{s.title}</h3>
