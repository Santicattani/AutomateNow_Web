    ...
    <section id="proceso" className="py-28 bg-black">
      <div className="w-full max-w-[1160px] mx-auto px-6">
        ...
        <div className="hidden md:grid grid-cols-4 gap-6 relative">
          ...
          />
          {steps.map((s) => (
            <div key={s.n} className="flex flex-col items-center text-center px-2 relative z-[1]">
              <div className="w-[52px] h-[52px] rounded-full bg-black border-2 border-[#7D00DC] flex items-center justify-center font-['Syne'] font-extrabold text-base text-[#7D00DC] mb-6 relative z-[2] shadow-[0_0_0_6px_black] flex-shrink-0">
                {s.n}
              </div>
              <h3 className="font-['Syne'] text-[0.9rem] font-bold text-white mb-[0.4rem]">{s.title}</h3>
        ...
        <div className="flex flex-col gap-8 md:hidden">
          {steps.map((s) => (
            <div key={s.n} className="flex items-start gap-5 text-left">
              <div className="w-[52px] h-[52px] rounded-full bg-black border-2 border-[#7D00DC] flex items-center justify-center font-['Syne'] font-extrabold text-base text-[#7D00DC] flex-shrink-0">
                {s.n}
              </div>
              <div>
                <h3 className="font-['Syne'] text-[0.9rem] font-bold text-white mb-[0.4rem]">{s.title}</h3>
