      ...
      <div className="w-full max-w-[1160px] mx-auto px-6">
        <FadeInUp>
          ...
          <div className="max-w-[640px] mb-12">
            <h2 className="font-['Syne'] text-[clamp(1.5rem,2.5vw,2.1rem)] font-bold text-white mb-5 leading-[1.1]">
        ...
        >
          {cards.map((c) => (
            ...
            >
              <div>
                <h3 className="font-['Syne'] text-base font-bold text-white mb-[0.6rem]">{c.title}</h3>
                <p className="text-[0.875rem] text-[#9CA3AF] leading-[1.6]">{c.desc}</p>
              </div>
              <span className="absolute bottom-5 right-6 font-['Syne'] text-[3.5rem] font-extrabold text-[rgba(255,255,255,0.04)] leading-none select-none group-hover:text-[rgba(125,0,220,0.08)] transition-colors">
                {c.num}
              </span>
            </motion.div>
          ))}
